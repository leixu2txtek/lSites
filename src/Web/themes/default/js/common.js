    ...
    $.ajax({
        ...
        $.each(menus[r.current.role], function (i, v) {
            ...
            if (v.children && v.children.length > 0) {
                ...
                li.find('a:first').append('<i class="iconfont group-icon-tianjia sub-add"></i>');
