    ...
    function setTabFocus(id) {
        ...
        switch (id) {
            case 'remote':
                ...
                break;
            case 'upload':
                setAlign(config.imageInsertAlign);
    ...
    function initButtons() {
        ...
        dialog.onok = function () {
            ...
            for (var i = 0; i < list.length; i++) {
                ...
                if (p.src.indexOf('&width=') == -1 && p.src.indexOf('&height=') == -1) {
    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            var _this = this,
                ...
                // WebUploader实例
                uploader,
                actionUrl = config.imageActionName,
                acceptExtensions = (config.imageAllowFiles || []).join('').replace(/\./g, ',').replace(/^[,]/, ''),
            ...
            if (!WebUploader.Uploader.support()) {
                ...
                return;
            } else if (!config.imageActionName) {
            ...
            uploader = _this.uploader = WebUploader.create({
                ...
                server: actionUrl,
                fileVal: config.imageFieldName || 'image',
                paste: document.body,
                duplicate: true,
                sendAsBinary: false,
                fileSingleSizeLimit: imageMaxSize,    // 默认 2 M
                compress: config.imageCompressEnable ? {
